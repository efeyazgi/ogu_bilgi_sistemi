    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (summary.gpa != null && (summary.akts != null || summary.credits != null))
            const SizedBox(height: 5),
          if (summary.akts != null)
             RichText(
              text: TextSpan(
                style: Theme.of(context).textTheme.titleMedium, // Using titleMedium for better visibility
                children: [
                  const TextSpan(
                    text: 'Toplam/Başarılan AKTS: ',
                    style: TextStyle(fontWeight: FontWeight.bold),
                  ),
                  TextSpan(text: summary.akts),
                ],
              ),
            )
          else if (summary.credits != null)
            Text(
